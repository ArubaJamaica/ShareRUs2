...
import java.util.Scanner;
	public class User {
			...
			//constructor
			public User(String firstname, String lastname, String address, int postcode, String dateofbirth, String telephone, String cpr, String username, String password){
